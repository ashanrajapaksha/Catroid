...
public class ProjectUploadService extends IntentService {
	...
	public void onDestroy() {
		if (!result) {
			Toast.makeText(this, getResources().getText(R.string.error_project_upload).toString()+" "+serverAnswer, Toast.LENGTH_LONG).show();
			StatusBarNotificationManager.getInstance().showOrUpdateNotifciation(notificationId,100,getResources().getText(R.string.notification_upload_rejected).toString());
		}
		else {
